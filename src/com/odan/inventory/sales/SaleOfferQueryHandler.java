...
public class SaleOfferQueryHandler implements IQueryHandler {

	@Override
	public Object getById(Long id) throws CommandException {
		SaleOffer s = (SaleOffer) HibernateUtils.get(SaleOffer.class, id);
		return s;
	}
	...
	public List<Object> get(Query q) {
		...
		List<Object> sales = HibernateUtils.select("FROM SaleOffer " + whereSQL, sqlParams, limit, offset);
		return sales;
	}
